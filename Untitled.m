...
current = fopen('E:\Piotr\Programowanie\C#\AISDE2\Lab2Console\Lab2Console\current.txt'); % otwiera plik
...
vp = fopen('E:\Piotr\Programowanie\C#\AISDE2\Lab2Console\Lab2Console\vpList.txt'); % otwiera plik
